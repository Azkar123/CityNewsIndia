...
public class AppUtilities {
    ...
    public static void shareApp(Activity activity) {
        try {
            ...
            sendIntent.putExtra(Intent.EXTRA_TEXT, activity.getResources().getString(R.string.share_text) + " http://citynewsindia.in/"/* appPackageName*/);
    ...
    public static void rateThisApp(Activity activity) {
        try {
            activity.startActivity(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("http://citynewsindia.in" /*+ activity.getPackageName()*/)));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
